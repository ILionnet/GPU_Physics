...
public class SimplePhysics : MonoBehaviour
{
    ...
    void InitShader()
    {
        ballsBuffer = new ComputeBuffer(numOfBalls, 10 * sizeof(float)); //Vector3 + Vector3 + Color = 3+3+4 = 10
        ...
        shader.SetVector("limitsXZ", new Vector4(-5f+radius, 5f-radius, -5f+radius, 5f-radius));
        shader.SetFloat("floorY", -5f+radius);
